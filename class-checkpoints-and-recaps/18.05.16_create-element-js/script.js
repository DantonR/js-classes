(function() {
	...
	newP.setAttribute('style', 'font-size: 24px; color: #333; font-family: Helvetica; border: 1px solid #90E7FD; padding: 15px; border-radius: 10px; max-width:500px; margin: 0 auto;'); // Takes the newP and uses the method setAttribute, which allows the changing of all the styling
